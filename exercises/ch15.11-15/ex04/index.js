// list.innerHTMLを丸ごと保存すれば、localStorageから読み出す時にイベントリスナーが消えてしまうため
...
// taskList: localStorage から取得したタスクのリスト、まだは空のリスト
let taskList = [];
// currentId: localStorage から取得、まだは0
let currentId = 0;
...
// localStorage から取得したタスクオブジェクトを受け取って、ToDo リストの要素を追加する
